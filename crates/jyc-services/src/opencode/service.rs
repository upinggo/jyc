...
use jyc_utils::constants::{HEARTBEAT_INTERVAL, MIN_HEARTBEAT_ELAPSED};
use tokio::sync::mpsc;
...
pub struct OpenCodeService {
    ...
    app_config: Arc<ArcSwap<jyc_types::AppConfig>>,
    workdir: PathBuf,
...
impl OpenCodeService {
    ...
    async fn generate_reply(
        ...
        jyc_mcp::context::save_reply_context(thread_path, &jyc_mcp::context::ReplyContext {
