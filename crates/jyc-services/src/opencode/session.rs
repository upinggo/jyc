...
use jyc_types::{AgentConfig, AppConfig, McpServerConfig, McpServerKind};
...
mod tests {
    ...
    fn test_mcp_config_to_json_local() {
        use jyc_types::{McpServerConfig, McpServerKind};
    ...
    async fn test_ensure_thread_opencode_setup_with_template_mcps() {
        use jyc_types::{AgentConfig, AppConfig, McpServerConfig, McpServerKind, HeartbeatConfig};
        use std::collections::HashMap;
    ...
    async fn test_ensure_thread_opencode_setup_without_mcps_json() {
        use jyc_types::{AgentConfig, AppConfig, HeartbeatConfig};
        use std::collections::HashMap;
